...
urlpatterns = [
    ...
    path('goal_category/list', views.GoalCategoryListView.as_view(), name='create-list'),
    ...
    path('goal_comment/create', views.GoalCreateView.as_view(), name='create-comment'),
    path('goal_comment/list', views.GoalListView.as_view(), name='comment-list'),
    path('goal_comment/<int:pk>', views.GoalView.as_view(), name='comment'),
]